...
######################################################
    ...
    #####################################################
        ...
        rospy.Subscriber("lwheel_encoder", Int16, self.wheelCallback) 
        rospy.Subscriber('lwheel_vtarget', Float32, self.targetCallback)

        self.pub_motor = rospy.Publisher("lmotor_cmd",Int16, queue_size=10) 
        self.pub_vel = rospy.Publisher("lwheel_vel", Int16, queue_size=10)
