...
######################################################
    ...
    #####################################################
        ...
        rospy.Subscriber("rwheel_encoder", Int16, self.wheelCallback) 
        rospy.Subscriber('rwheel_vtarget', Float32, self.targetCallback) 
        self.pub_motor = rospy.Publisher("rmotor_cmd",Int16, queue_size=10) 
        self.pub_vel = rospy.Publisher("rwheel_vel", Int16, queue_size=10)
