...
def generate_launch_description():
    ...
    # pointcloud_laserscan_launch_path = PathJoinSubstitution(
    #     [FindPackageShare('core0_cpp_robot'), 'launch', 'core0_pointcloud_laserscan.launch.py']
    # )
    pointcloud_laserscan_launch_path = os.path.join(pkg_share, 'launch', 'core0_pointcloud_laserscan.launch.py')
  ...
  # Start Gazebo client    
    ...
    start_pcl2_ls=IncludeLaunchDescription(
            PythonLaunchDescriptionSource(pointcloud_laserscan_launch_path)
        )
